...
def insertar_catalogo_programas(db: Session, df_programas):
    ...
    insert_programa_sql = text("""
        ...
        ON DUPLICATE KEY UPDATE 
            ...
            PRF_version = COALESCE(VALUES(PRF_version), PRF_version),
            nombre_programa = COALESCE(VALUES(nombre_programa), nombre_programa),
            tipo_formacion = COALESCE(VALUES(tipo_formacion), tipo_formacion),
            nivel_formacion = COALESCE(VALUES(nivel_formacion), nivel_formacion),
            duracion_maxima = COALESCE(VALUES(duracion_maxima), duracion_maxima),
            dur_etapa_lectiva = COALESCE(VALUES(dur_etapa_lectiva), dur_etapa_lectiva),
            dur_etapa_productiva = COALESCE(VALUES(dur_etapa_productiva), dur_etapa_productiva),
            fecha_registro = COALESCE(VALUES(fecha_registro), fecha_registro),
            fecha_activo = COALESCE(VALUES(fecha_activo), fecha_activo),
            edad_min_requerida = COALESCE(VALUES(edad_min_requerida), edad_min_requerida),
            grado_min_requerido = COALESCE(VALUES(grado_min_requerido), grado_min_requerido),
            descripcion_req = COALESCE(VALUES(descripcion_req), descripcion_req),
            resolucion = COALESCE(VALUES(resolucion), resolucion),
            fecha_resolucion = COALESCE(VALUES(fecha_resolucion), fecha_resolucion),
            apoyo_fic = COALESCE(VALUES(apoyo_fic), apoyo_fic),
            creditos = COALESCE(VALUES(creditos), creditos),
            alamedida = COALESCE(VALUES(alamedida), alamedida),
            linea_tecnologica = COALESCE(VALUES(linea_tecnologica), linea_tecnologica),
            red_tecnologica = COALESCE(VALUES(red_tecnologica), red_tecnologica),
            red_conocimiento = COALESCE(VALUES(red_conocimiento), red_conocimiento),
            modalidad = COALESCE(VALUES(modalidad), modalidad),
            apuestas_prioritarias = COALESCE(VALUES(apuestas_prioritarias), apuestas_prioritarias),
            fic = COALESCE(VALUES(fic), fic),
            tipo_permiso = COALESCE(VALUES(tipo_permiso), tipo_permiso),
            multiple_inscripcion = COALESCE(VALUES(multiple_inscripcion), multiple_inscripcion),
            indice = COALESCE(VALUES(indice), indice),
            ocupacion = COALESCE(VALUES(ocupacion), ocupacion),
