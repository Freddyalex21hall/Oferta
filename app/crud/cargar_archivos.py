...
def insertar_estado_normas(db: Session, df_normas):
    ...
    #         data = {
    #             "cod_programa": _to_int_safe(row.get("cod_programa")),
    #             "cod_version": _safe_val(row.get("cod_version")),
    #             "fecha_elaboracion": _parse_date(row.get("fecha_elaboracion")),
    #             "anio": _to_int_safe(row.get("anio")),
    #             "red_conocimiento": _safe_val(row.get("red_conocimiento")),
    #             "nombre_ncl": _safe_val(row.get("nombre_ncl")),
    #             "cod_ncl": _to_int_safe(row.get("cod_ncl")),
    #             "ncl_version": _to_int_safe(row.get("ncl_version")),
    #             "norma_corte_noviembre": _safe_val(row.get("norma_corte_noviembre")),
    #             "version": _safe_val(row.get("version_norma")),
    #             "norma_version": _safe_val(row.get("norma_version")),
    #             "mesa_sectorial": _safe_val(row.get("mesa_sectorial")),
    #             "tipo_norma": _safe_val(row.get("tipo_norma")),
    #             "observacion": _safe_val(row.get("observacion")),
    #             "fecha_revision": _parse_date(row.get("fecha_revision")),
    #             "tipo_competencia": _safe_val(row.get("tipo_competencia")),
    #             "vigencia": _safe_val(row.get("vigencia")),
    #             "fecha_indice": _parse_date(row.get("fecha_indice")),
    #         }
    ...
    #         db.rollback()
    #         errores.append(
    #             {"fila": idx + 1, "error": str(e)}
    #         )
    #         logger.exception(f"Error insertando norma en fila {idx+1}: {e}")
